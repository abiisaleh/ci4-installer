...
IF NOT EXIST "c://xampp/htdocs/%repo%" (
    ...
    composer update & call start c://xampp/mysql_start.bat & c://xampp/mysql/bin/mysql.exe -u root -p %repo% < file.sql & start php spark serve & start msedge http://localhost:8080 & EXIT
)
